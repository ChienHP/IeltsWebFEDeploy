...
// type: 9 Summary_Note_Completion
const question6_9 = {
    from:6,
    to:9,
    type: 9,
...
export const IeltsReadingTest = async () => {
    ...
    return (
        <div className="reading-box">
            <div className='split'>
                <h1><strong>READING PASSAGE {readingPassage.passageNumber}</strong></h1>
            ...
            <div className="split">
                <YesNoNotGiven questions = {question1_5} handleChange={handleChange}></YesNoNotGiven>
